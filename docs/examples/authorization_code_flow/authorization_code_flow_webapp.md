...
This document explains how to develop a client program for the Suomen
Tilaajavastuu Unified Resource API. We will develop a small web
application in Python 2.7, using some libraries, on the Debian 8 (code
name jessie) operating system. The following Debian packages are
needed:
